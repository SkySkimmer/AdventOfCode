(** IntCode V4.0
    ...
    Change input/output system to be more flexible.
*)
...
let new_robot () = { state = make_state (); pos = (0, 0); dir = Up }

let seen = robot_paint PMap.empty (new_robot ())
