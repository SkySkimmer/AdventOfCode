...
(** IntCode V3.0
    ...
    Add Relative mode and relative offset opcode
    Add extra memory (10k cells seem enough)
    Description says bigint is needed but OCaml's 63 bits seems enough

    Remove pipe system, instead we just output to stdout again.
*)
